...
public class ImageMark {
    ...
    public void MarkByImage(String markImage, String sourceImage, String out, String imageType) {
        try {
    ...
    public void markByText(String sourceImage, String out, String imageType, String text) {
        try {
            File source = new File(sourceImage);
            Image s = ImageIO.read(source);
            int s_width = s.getWidth(null);
    ...
    public  String markByText2(String sourceImage, String out, String imageType, String text,String name) {
        try {
            ...
            graphics2d.drawString(text, x, y);
            graphics2d.dispose();
            File file=new File(out,name+"_mark."+imageType);
            ImageIO.write(bufferedImage, imageType, file);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return name+"_mark."+imageType;
    }
}
